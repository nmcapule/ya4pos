...
import * as $4 from "./routes/api/v1/warehouses/index.ts";
import * as $5 from "./routes/index.tsx";
import * as $6 from "./routes/sandbox/index.tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/api/v1/warehouses/index.ts": $4,
    "./routes/index.tsx": $5,
    "./routes/sandbox/index.tsx": $6,
  },
  islands: {
