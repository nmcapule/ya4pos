...
import * as $9 from "./routes/api/v1/transfers/[id]/items/index.ts";
import * as $10 from "./routes/api/v1/transfers/_validators.ts";
import * as $11 from "./routes/api/v1/transfers/index.ts";
import * as $12 from "./routes/api/v1/transmutes/index.ts";
import * as $13 from "./routes/api/v1/warehouses/[id]/index.ts";
import * as $14 from "./routes/api/v1/warehouses/[id]/stocks.ts";
import * as $15 from "./routes/api/v1/warehouses/index.ts";
import * as $16 from "./routes/index.tsx";
import * as $17 from "./routes/sandbox/index.tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/api/v1/transfers/[id]/items/index.ts": $9,
    "./routes/api/v1/transfers/_validators.ts": $10,
    "./routes/api/v1/transfers/index.ts": $11,
    "./routes/api/v1/transmutes/index.ts": $12,
    "./routes/api/v1/warehouses/[id]/index.ts": $13,
    "./routes/api/v1/warehouses/[id]/stocks.ts": $14,
    "./routes/api/v1/warehouses/index.ts": $15,
    "./routes/index.tsx": $16,
    "./routes/sandbox/index.tsx": $17,
  },
  islands: {
